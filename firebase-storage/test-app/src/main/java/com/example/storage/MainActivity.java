...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    clickButton.setOnClickListener(v -> runTaskTest("listSinglePage", () -> TestCommandHelper.listFiles(10, 1)));

      clickButton = findViewById(R.id.listMultplePages);
      clickButton.setOnClickListener(v -> runTaskTest("listMultplePages", () -> TestCommandHelper.listFiles(10, 10)));
